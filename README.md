...
## 😀 About Me
저는 경북소프트웨어마이스터고등학교 1기 재학생입니다.

데이터 분석과 머신러닝을 활용해 문제를 해결하는 과정에 흥미를 느끼고 있습니다.
데이터를 분석하고 패턴을 발견하여 의미 있는 인사이트를 도출하는 것을 좋아합니다.

문제를 끝까지 해결하려는 끈기와 꾸준히 배우는 태도를 중요하게 생각합니다.
...
## 🌱 BeakJoon
[![solved.ac tier](http://mazassumnida.wtf/api/v2/generate_badge?boj=여기에_백준_아이디)](https://solved.ac/여기에_백준_아이디)
